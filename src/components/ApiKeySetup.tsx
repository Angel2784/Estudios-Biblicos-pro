      ...
      >
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-5">
          ...
          <button
            ...
            className="w-full disabled:bg-gray-600 disabled:cursor-not-allowed font-semibold rounded-lg py-3 text-sm transition-colors"
            style={
              !key.trim() || status === "testing"
                ? {}
                : { background: "linear-gradient(90deg, #d4a017 0%, #f0c040 50%, #d4a017 100%)", color: "#0a1628" }
            }
          >
